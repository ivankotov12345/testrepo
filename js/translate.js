...
const langBtn = document.querySelectorAll('.lang-btn');
  ...
  function changeLang (langSwitcher) {
    langBtn.forEach(el => el.classList.remove('active-switcher'));
    if (langSwitcher.target.classList.contains('lang-btn')) {
      langSwitcher.target.classList.add('active-switcher');
    }
  }
  ...
  function getTranslate(lang) {
    ...
    tr.forEach(el => {el.textContent = i18Obj[lang][el.dataset.i18];
    })
